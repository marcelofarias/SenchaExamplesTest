...
public class XMLGridTest extends BaseExampleTest {

    public XMLGridTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/grid/xml-grid.html";
    }
