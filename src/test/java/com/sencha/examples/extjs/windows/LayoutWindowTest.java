...
public class LayoutWindowTest extends BaseExampleTest {

    public LayoutWindowTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/window/layout.html";
    }
