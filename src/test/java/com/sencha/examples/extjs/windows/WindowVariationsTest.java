...
public class WindowVariationsTest extends BaseExampleTest {

    public WindowVariationsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/window/window.html";
    }
