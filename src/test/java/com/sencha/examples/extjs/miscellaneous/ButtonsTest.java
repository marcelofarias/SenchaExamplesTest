...
public class ButtonsTest extends BaseExampleTest {

    public ButtonsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#basic-buttons";
    }
