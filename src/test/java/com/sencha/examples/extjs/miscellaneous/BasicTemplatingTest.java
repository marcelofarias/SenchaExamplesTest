...
public class BasicTemplatingTest extends BaseExampleTest {

    public BasicTemplatingTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/platform/templates.html";
    }
