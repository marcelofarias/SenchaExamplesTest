...
public class BrowserStateManagementTest extends BaseExampleTest {

    public BrowserStateManagementTest(String platform, String browser, String version, String theme) {
