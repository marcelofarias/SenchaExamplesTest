...
public class SpotlightTest extends BaseExampleTest {

    public SpotlightTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/core/spotlight.html";
    }
