...
public class KeyboardNavigationTest extends BaseExampleTest {

    public KeyboardNavigationTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/keynav/keynav.html";
    }
