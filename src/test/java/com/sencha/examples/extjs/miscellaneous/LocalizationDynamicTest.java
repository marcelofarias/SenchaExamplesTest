...
public class LocalizationDynamicTest extends BaseExampleTest {

    public LocalizationDynamicTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/locale/multi-lang.html";
    }
