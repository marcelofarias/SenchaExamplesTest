...
public class EditorTest extends BaseExampleTest {

    public EditorTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/simple-widgets/editor.html";
    }
