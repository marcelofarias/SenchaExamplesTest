...
public class LocalizationStaticTest extends BaseExampleTest {

    public LocalizationStaticTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/locale/dutch-form.html";
    }
