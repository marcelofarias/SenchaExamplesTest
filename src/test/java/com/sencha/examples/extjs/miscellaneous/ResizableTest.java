...
public class ResizableTest extends BaseExampleTest {

    public ResizableTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/resizer/basic.html";
    }
