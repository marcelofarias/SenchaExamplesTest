...
public class PortalTest extends BaseExampleTest {

    public PortalTest(String platform, String browser, String version, String theme) {
...
//        saveScreenshot("combination.Portal");
    }
