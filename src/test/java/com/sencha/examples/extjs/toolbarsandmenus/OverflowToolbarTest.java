...
public class OverflowToolbarTest extends BaseExampleTest {

    public OverflowToolbarTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/toolbar/overflow.html";
    }
