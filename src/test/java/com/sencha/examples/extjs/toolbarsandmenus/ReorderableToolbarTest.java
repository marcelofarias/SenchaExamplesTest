...
public class ReorderableToolbarTest extends BaseExampleTest {

    public ReorderableToolbarTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/toolbar/reorderable.html";
    }
