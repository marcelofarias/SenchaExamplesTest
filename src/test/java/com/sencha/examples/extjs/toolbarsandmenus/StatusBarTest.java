...
public class StatusBarTest extends BaseExampleTest {

    public StatusBarTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/statusbar/statusbar-demo.html";
    }
