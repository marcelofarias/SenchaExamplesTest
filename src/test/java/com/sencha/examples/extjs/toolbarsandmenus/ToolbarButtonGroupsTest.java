...
public class ToolbarButtonGroupsTest extends BaseExampleTest {

    public ToolbarButtonGroupsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/toolbar/toolbars.html";
    }
