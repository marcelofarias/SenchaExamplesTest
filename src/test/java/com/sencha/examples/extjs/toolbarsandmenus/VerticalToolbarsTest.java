...
public class VerticalToolbarsTest extends BaseExampleTest {

    public VerticalToolbarsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/toolbar/vertical-toolbars.html";
    }
