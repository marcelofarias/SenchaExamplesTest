...
public class StatusBarAdvancedTest extends BaseExampleTest {

    public StatusBarAdvancedTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/statusbar/statusbar-advanced.html";
    }
