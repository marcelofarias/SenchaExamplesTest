...
public class BasicToolbarTest extends BaseExampleTest {

    public BasicToolbarTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/menu/menus.html";
    }
