...
public class TigerTest extends BaseExampleTest {

    public TigerTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/charts-kitchensink/#tiger-draw";
    }
