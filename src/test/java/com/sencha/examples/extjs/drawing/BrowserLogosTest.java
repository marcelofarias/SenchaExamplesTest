...
public class BrowserLogosTest extends BaseExampleTest {

    public BrowserLogosTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/charts-kitchensink/#logos-draw";
    }
