...
public class DirectNamedArgumentsTest extends BaseExampleTest {

    public DirectNamedArgumentsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/direct/named-arguments.html";
    }
