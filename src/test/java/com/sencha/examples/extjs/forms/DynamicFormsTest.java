...
public class DynamicFormsTest extends BaseExampleTest {

    public DynamicFormsTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/form/dynamic.html";
    }
