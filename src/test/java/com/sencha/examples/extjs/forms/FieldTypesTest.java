...
public class FieldTypesTest extends BaseExampleTest {

    public FieldTypesTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#field-types";
    }
