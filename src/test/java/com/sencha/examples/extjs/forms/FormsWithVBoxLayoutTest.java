...
public class FormsWithVBoxLayoutTest extends BaseExampleTest {

    public FormsWithVBoxLayoutTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#form-vboxlayout";
    }
