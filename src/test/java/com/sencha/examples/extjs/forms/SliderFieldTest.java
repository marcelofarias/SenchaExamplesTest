...
public class SliderFieldTest extends BaseExampleTest {

    public SliderFieldTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#slider-field";
    }
