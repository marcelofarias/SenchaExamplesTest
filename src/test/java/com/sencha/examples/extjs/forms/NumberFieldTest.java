...
public class NumberFieldTest extends BaseExampleTest {

    public NumberFieldTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#form-number";
    }
