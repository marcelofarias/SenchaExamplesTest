...
public class FormsWithFieldReplicationTest extends BaseExampleTest {

    public FormsWithFieldReplicationTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#field-replicator";
    }
