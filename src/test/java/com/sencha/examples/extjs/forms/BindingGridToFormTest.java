...
public class BindingGridToFormTest extends BaseExampleTest {

    public BindingGridToFormTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#form-grid";
    }
