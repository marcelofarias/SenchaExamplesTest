...
public class GridCellToCellDragAndDropTest extends BaseExampleTest {

    @Rule
    public SauceOnDemandTestWatcher resultReportingTestWatcher = new SauceOnDemandTestWatcher(this, authentication);
    
    public GridCellToCellDragAndDropTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/dd/cell-to-cell-dd.html";
    }
