...
public class FieldToGridDragAndDropTest extends BaseExampleTest {

    @Rule
    public SauceOnDemandTestWatcher resultReportingTestWatcher = new SauceOnDemandTestWatcher(this, authentication);
    
    public FieldToGridDragAndDropTest(String platform, String browser, String version, String theme) {
        super(platform, browser, version, theme);
    }
    
    @Override
    protected String getExamplePath() {
        return "/kitchensink/#dd-field-to-grid";
    }
